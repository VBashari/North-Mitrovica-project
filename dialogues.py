...
def box_text(surface, font, text, position, text_color, bg_color):
    x = position[0]
    y = position[1]
...
def display_dialogue(surface, dialogue_list, text_color, bg_color):
    for line in dialogue_list:
        ...
        box_text(surface, pixel_font, line, (130, 530), text_color, bg_color)
...
rock_school_diag = ['Oh, hey there, stranger!', 'Are you here to listen to our concert later tonight?', 'They\'ve '
                                                                                                        'gotten quite '
                                                                                                        'popular '
                                                                                                        'recently.',
                    'I\'m glad our school is growing! It kind of reminds me of the city\'s jazz age.', 'Maybe music '
                                                                                                       'will unite us'
                                                                                                       ' again, '
                                                                                                       'just like '
                                                                                                       'back then...']
